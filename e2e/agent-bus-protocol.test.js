...
test.describe('Velora A2A agent card protocol', () => {
  ...
  test('agent card consume EmployeeEvent v1 con los event types esperados', () => {
    ...
    const expected = ['LOW_STOCK', 'SHIFT_START', 'SHIFT_END', 'CASH_AT_RISK', 'BULK_IMPORT_COMPLETED'];
