...
export const defaultCopy: LandingCopy = {
  ...
  surfaces: {
    ...
    entries: [
      ...
      },
      {
        ...
        badge: "Próximamente en el directorio",
        available: false,
      },
      {
        name: "Claude / Cowork",
  ...
  widgets: {
    ...
    placeholder:
      "Capturas de los widgets disponibles próximamente. ¿Querés verlo en vivo? Escribinos a contact@example.com.",
  },
  integraciones: {
    title: "Integraciones",
  ...
  faq: {
    ...
    subtitle: "Si falta algo, escribinos a contact@example.com.",
    items: [
      {
        q: "¿Qué es Velora?",
