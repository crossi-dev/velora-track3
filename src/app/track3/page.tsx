...
const REPO = "https://github.com/crossi-dev/velora-track3";
...
const MANDATORY_TECH = [
  ...
  {
    label: "Cloud Run",
    detail: "Production deployment in southamerica-east1. Scale-to-zero by default (--min-instances=0). Run scripts/demo-mode.mjs to warm a min-instance for the judging window.",
  ...
  },
  {
    ...
    detail: "LIVE in production (USE_VERTEX_SEARCH=true). Per-tenant Discovery Engine datastores provisioned and indexed. Semantic queries verified: \"bolso para la espalda\" → Mochila, \"para tomar mate\" → Mate. Resolves Argentine regional synonyms (destornillador ↔ desarmador) the SQL fuzzy matcher misses.",
      ...
      <div style={styles.wrap}>
        ...
        <section style={styles.section}>
          ...
          <p style={{ color: "#555", marginBottom: "1.5rem" }}>
            All eight Track 3 mandatory technologies are implemented. Six are active in
            production; two are implemented and wired but feature-flagged for cost control
            (`USE_EMBEDDINGS`, `USE_AGENT_ENGINE`).
