...
// directly. Same "orphan server entry" pattern as employee.create and
// mp_connection.disconnect: the entry exists in SERVER_MUTATION_CONTRACT
// so requiresIdempotency/requiresTrace cover it, but there is no route
// declaration and it does not appear in CANONICAL_ACTION_KEYS.
//
// Splitting this out of mutation-contract-entries.ts keeps that module
// under the hard limit of 300 LOC (project conventions).
